...
namespace Markify.Rendering.T4.Tests
{
    public sealed partial class DefinitionFormatter_Tests
    {
        ...
        [Theory]
        [DefinitionData("Foo", null, new string[] { }, null, "internal")]
        ...
        [Theory]
        [DefinitionData("Foo", null, new string[] { "public" }, null, "public")]
        [DefinitionData("Foo", null, new string[] { "protected", "internal" }, null, "protected internal")]
